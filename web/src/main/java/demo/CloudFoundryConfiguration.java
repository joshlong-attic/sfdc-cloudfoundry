...
@Configuration
 @Profile("cloud")
@PropertySource("/sfdc-cloud.properties")
class CloudFoundryConfiguration {
    ...
    */
    ...
    DataSource dataSource(Cloud cloud) {
        ...
        Assert.isTrue(serviceInfos.size() >= 1, "you must bind to a MySQL instance for this application");
    ...
    ConnectionFactory connectionFactory(Cloud cloud) {
        ...
        Assert.isTrue(rabbitServiceInfo.size() >= 1, "you must bind to a RabbitMQ instance for this application");
